...
$userModel = $model->getTeacherNoUser();
?>
<!DOCTYPE html>
<html lang="en">
          ...
          <div id="password-form">
            <form action="../../controller/UserController.php?action=insert" method="post">
              ...
              ?>
                ...
                <select name="giangvien" id="giangvien" disabled></select><br>
                <button type="submit" class="btn btn-primary" disabled>Thêm</button>

              <?php
                echo '<script type="text/javascript">alert("Không có giáo viên để tạo tài khoản ");</script>';
              } else {
                $firstrow = $userModel[0];
              ?>
                <label for="username">Nhập tài khoản</label>
                <input type="text" name="username" id="username" value="<?= $firstrow['ma_gv'] ?>"><br>
                <p class="error-p">
                  <?php
                ...
                <select name="giangvien" id="giangvien">
                  ...
                  ?>
                    <option value="<?php echo $user['ma_gv'] ?>"><?php echo $user['ho_lot_gv'] . ' ' . $user['ten_gv']; ?></option>
                  <?php
                  }
                  ?>
                </select><br>
